...
from action.file_utils import ensure_dir
from action.initial_watcher import ActionInitialWatcher
from action.followup_watcher import ActionFollowupWatcher
...
def main():
    ...
    print()
    print("=" * 60)
    print("[INFO] action 패키지 시작")
    print("[INFO] action 입력 폴더: {}".format(INPUT_DIR))
    print("[INFO] action 초안 폴더: {}".format(DRAFT_DIR))
    ...
    initial_watcher = ActionInitialWatcher(
        input_dir=INPUT_DIR,
        done_dir=DONE_DIR,
        draft_dir=DRAFT_DIR,
    ...
    followup_watcher = ActionFollowupWatcher(
